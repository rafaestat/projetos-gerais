...
<execution_context>
@/home/user/projetos-gerais/.claude/gsd-core/workflows/manager.md
...
Read and execute `/home/user/projetos-gerais/.claude/gsd-core/workflows/analyze-dependencies.md` end-to-end.
