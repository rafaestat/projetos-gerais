...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/projetos-gerais/.claude/.gsd-surface.json`
(sibling to `/home/user/projetos-gerais/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/projetos-gerais/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/projetos-gerais/.claude/skills`).
...
`/home/user/projetos-gerais/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/projetos-gerais/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/projetos-gerais/.claude/.gsd-surface.json`
Install profile marker: `/home/user/projetos-gerais/.claude/.gsd-profile`
Skill dirs: `/home/user/projetos-gerais/.claude/skills/gsd-*/`
Engine module: `/home/user/projetos-gerais/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/projetos-gerais/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
