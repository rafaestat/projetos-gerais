...
```
Agent(
  prompt="Read /home/user/projetos-gerais/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/projetos-gerais/.claude/gsd-core/templates/VALIDATION.md`
