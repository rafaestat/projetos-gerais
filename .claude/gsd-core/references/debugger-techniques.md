...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/projetos-gerais/.claude
                  → checks /home/user/projetos-gerais/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/projetos-gerais/.claude/gsd-core
                  → writes to /home/user/projetos-gerais/.claude/gsd-core/hooks/
