...
Three types: **checkpoint:human-verify (90%)**, **checkpoint:decision (9%)**, **checkpoint:human-action (1% - rare)**. Full "use for" criteria and XML templates for each: @/home/user/projetos-gerais/.claude/gsd-core/references/checkpoints.md
...
Non-file coupling: @/home/user/projetos-gerais/.claude/gsd-core/references/planner-coupling.md
</step>
...
See @/home/user/projetos-gerais/.claude/gsd-core/references/planner-guidance.md for return formats; gap-closure returns are artifact-based (#3440).
