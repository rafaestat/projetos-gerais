...
<reference>
@/home/user/projetos-gerais/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/projetos-gerais/.claude/gsd-core/references/user-profiling.md` to load:
