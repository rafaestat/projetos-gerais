...
Reference full template: `/home/user/projetos-gerais/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/projetos-gerais/.claude/gsd-core/templates/state.md`.
